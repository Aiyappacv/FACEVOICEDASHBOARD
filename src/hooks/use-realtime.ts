...
export function useRealtimeMetrics(initialMetrics: any[]) {
...
export function useRealtimeActivity(initialEvents: any[]) {
...
export function usePipelineAnimation(totalStages: number = 9) {
